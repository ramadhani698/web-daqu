...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($pembiaya_sekolah == '') $errors[] = "Yang membiayai sekolah belum diisi.";

    $no_kk = $_POST['no_kk'] ?? '';
    $nama_kepala_keluarga = $_POST['nama_kepala_keluarga'] ?? '';
    $nama_ayah = $_POST['nama_ayah'] ?? '';
    $status_ayah = $_POST['status_ayah'] ?? '';
    if ($status_ayah == '') $errors[] = "Status ayah kandung belum diisi.";
    ...
    if ($status_ibu == '') $errors[] = "Status ibu kandung belum diisi.";
