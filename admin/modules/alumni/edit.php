    ...
    <form method="POST" enctype="multipart/form-data"> 
        ...
        <div class="mb-3"> 
            ...
            <select name="kategori" id="kategori" class="form-control" required> 
                <option value="sebaran" <?= $data['kategori'] == 'sebaran' ? 'selected' : '' ?>>Sebaran Alumni</option> 
                <option value="kiprah" <?= $data['kategori'] == 'kiprah' ? 'selected' : '' ?>>Kiprah Alumni</option> 
            </select> 
        </div> 
        <div class="mb-3"> 
            <label id="label-profesi"><?= $data['kategori'] == 'kiprah' ? 'Kampus' : 'Profesi' ?></label> 
            <input type="text" name="profesi" class="form-control" value="<?= htmlspecialchars($data['profesi']) ?>"> 
        </div> 
