...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO ketua_asrama (nama, asrama, urutan) VALUES ('$nama', '$asrama', '$urutan')";
    if (mysqli_query($conn, $query)) {
        header("Location: asrama.php?status=success");
        exit;
    } else {
  ...
  <div class="content-wrapper p-3">
    <div class="content-header">
      <div class="container-fluid">
        <h1 class="m-0">Tambah Ketua Asrama</h1>
      </div>
    </div>
